...
- Added a Skill Invocation Pass and read receipt requirement so risky skill calls must report selected skill, bounded source inspection, files read, approximate lines inspected, unread cited files, and Unknown claims.
